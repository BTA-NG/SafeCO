...
- **Formatter/linter:** ruff only (`pyproject.toml`). Rule sets: `E`/`W` pycodestyle, `F` pyflakes, `I` import order, `N` naming, `B` bugbear. Do not weaken rules without a PR discussion.
